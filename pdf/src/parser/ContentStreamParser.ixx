...
namespace vrock::pdf
{
    ...
    enum class ContentStreamOperator : uint16_t
    {
    ...
    export inline std::unordered_map<std::string, ContentStreamOperator> string_to_operator = {
    ...
    export class PDFOperator : public PDFBaseObject
    {
    public:
