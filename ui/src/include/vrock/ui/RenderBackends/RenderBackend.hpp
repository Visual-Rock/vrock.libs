...
namespace vrock::ui
{
    ...
    public:
        ...
        virtual auto draw_circle( Point position, float radius, Color color, int resolution = 25, float degrees = 360,
                                  float rotation = 0 ) const -> void = 0;
        virtual auto draw_ellipse( Point position, float x, float y, Color color, int resolution = 25, float deg = 360,
                                   float rotation = 0 ) const -> void = 0;
